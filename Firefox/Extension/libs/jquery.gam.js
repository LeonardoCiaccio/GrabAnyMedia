	...
	var config = {
		...
		buttons		: {
			...
			"youtube" : {
				...
				enabled : true,
				code 	: "!function(){var e='gambutton',t='meta-contents',n=function(){var e,t=window.ytplayer,n=[];if(!t)return n;try{e=t.config.args.url_encoded_fmt_stream_map}catch(o){return n}try{for(var r=e.split(','),a=0;a<r.length;a++){for(var u=r[a].split('&'),i={},l=0;l<u.length;l++){var c=u[l].split('='),d=decodeURIComponent(c[0].toUpperCase()),s=decodeURIComponent(c[1]);switch(d){case'TYPE':i.type=s;break;case'QUALITY':i.quality=s;break;case'URL':i.url=s}}i.type&&i.quality&&i.url&&n.push(i)}return n}catch(o){return n}},o=function(){if('undefined'==typeof window.gambuttonbuilder||document.querySelectorAll('.mygambutton').length>0)return!1;var o=document.getElementById(t);o&&o.classList.contains(e)&&o.classList.remove(e);var r=document.querySelectorAll('.mygambutton');if(r)for(var a=0;a<r.length;a++)r[a].parentNode.removeChild(r[a]);for(var u=n(),i=!0,l=0;i&&l<u.length;l++)try{var c=document.getElementById(t);if(u[l].url.indexOf('signature')<0){window.gambuttonbuilder(document.location.href.replace('youtube','10convert'),c,'" + chrome.i18n.getMessage( "m19" ) + "',!0);break}window.gambuttonbuilder(u[l].url,c,u[l].quality+' / '+u[l].type)}catch(d){i=!1}if(i){var c=document.getElementById(t);c&&!c.classList.contains(e)&&c.classList.add(e)}},r=document.body;if(!r)return!1;var a=new MutationObserver(function(e){e.forEach(function(){o()})}),u={childList:!0,subtree:!0};a.observe(r,u),o()}();"
